 ...
 *
 * 1. Copy the NewBlock folder to a new folder with the desired component name.
 * 2. Rename the component, schema, and template names from NewBlock to your chosen name.
 * 3. Import all elements of your new component in the files within the `blocks` folder, similar to how NewBlock is imported.
...
export { default as NewBlock } from './Component';
